...
ownership (P-CI-1) — Marid-owned files win on sync. (Note: `CLAUDE.md` reads upstream-flavored because it
was generated by analyzing the codebase, not copied from upstream's tree.)
