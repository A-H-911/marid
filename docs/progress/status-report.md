...
| Next milestone | **MS-007 (PH-6 Telegram-first)** — in progress; WBS-6.2/6.3/6.4 + **6.1 slice a+b** + **6.5 (reconnect + re-fetch recovery + attach-triggered re-subscribe)** done + EXP-005/007/008 PASS; **WBS-6.6 in progress** — live tiers PASS (2026-07-11): **AC-019/020/024 Met, AC-017 Partial**; INV-001 firehose leak found via the live tier & fixed (ADR-0016/0017; EXP-015/RISK-025). **NOT met:** AC-021 (TEST-TG-UI / EXP-009 Telegram-Web-Playwright + native-mobile — not built) → MS-007 pending AC-021 + 6.7 docs |
