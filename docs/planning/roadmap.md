...
| PH-7 WhatsApp adapter ✅ | New `@marid/whatsapp` unofficial-client channel (separate process, `channel:` token) — WAHA-NOWEB, outbound-only; ADR-0010/0014/0015 (Approved) | **MS-008 (MET 2026-07-18, PR #75 squash `3326a5f6b5`, all 23 CI green)**: AC-018/022/023 Met + EXP-006/011 PASS (fake-WA); 3-OS `marid-whatsapp` gate green; burner EXP-012 manual, never a gate (ADR-0014); no new `P-*`. **Last Marid milestone — plan complete.** | MS-006 (post-MVP; PH-6-independent; gated) |
