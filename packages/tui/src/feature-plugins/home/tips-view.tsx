...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Marid from reading sensitive files",
  "Use {highlight}marid run{/highlight} for non-interactive scripting",
  "Use {highlight}marid --continue{/highlight} to resume the last session",
  "Use {highlight}marid run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}marid serve{/highlight} for headless API access to Marid",
  "Use {highlight}marid run --attach{/highlight} to connect to a running server",
  "Run {highlight}marid upgrade{/highlight} to update to the latest version",
  "Run {highlight}marid auth list{/highlight} to see all configured providers",
  "Run {highlight}marid agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}marid github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}marid debug config{/highlight} to troubleshoot configuration",
