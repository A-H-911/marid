export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Marid.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Marid.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Marid.",
  ...
  "dialog.server.description": "Switch which Marid server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Marid",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Marid...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Marid in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Marid...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Marid in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Marid in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Marid",
  "wsl.onboarding.opencodeReadyIn": "Marid is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Marid is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Marid in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Marid",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Marid not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Marid can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Marid could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Marid.",
  ...
  "toast.update.description": "A new version of Marid ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Marid team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Marid does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Marid includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Marid Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Marid server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Marid",
  ...
  "settings.general.row.appearance.description": "Customise how Marid looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Marid follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Marid is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Marid launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Marid.",
